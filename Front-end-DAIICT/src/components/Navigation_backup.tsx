...
import { Shield, ArrowRight, ArrowLeft, Droplets, Menu, X, LogOut, User } from 'lucide-react';
                  ...
                  <div className="flex-1 py-6">
                    <nav className="space-y-4">
                      {currentUser ? (
                        <>
                          <SheetClose asChild>
                            <a href="#dashboard" className="flex items-center space-x-3 text-gray-700 hover:text-blue-600 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                              <User className="h-5 w-5" />
                              <span>Dashboard</span>
                            </a>
                          </SheetClose>
                          <SheetClose asChild>
                            <a href="#smart-contracts" className="flex items-center space-x-3 text-gray-700 hover:text-blue-600 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                              <Shield className="h-5 w-5" />
                              <span>Smart Contracts</span>
                            </a>
                          </SheetClose>
                          <SheetClose asChild>
                            <a href="#impact" className="flex items-center space-x-3 text-gray-700 hover:text-blue-600 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                              <ArrowRight className="h-5 w-5" />
                              <span>Impact</span>
                            </a>
                          </SheetClose>
                          <SheetClose asChild>
                            <a href="#security" className="flex items-center space-x-3 text-gray-700 hover:text-blue-600 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                              <Shield className="h-5 w-5" />
                              <span>Security</span>
                            </a>
                          </SheetClose>
                        ...
                        <>
                          <SheetClose asChild>
                            <a href="#home" className="flex items-center space-x-3 text-gray-700 hover:text-blue-600 p-3 rounded-lg hover:bg-gray-50 transition-colors">
